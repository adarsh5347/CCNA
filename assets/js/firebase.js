...
import { initializeFirestore, persistentLocalCache, persistentMultipleTabManager, doc, setDoc, getDoc } from 'https://www.gstatic.com/firebasejs/10.8.0/firebase-firestore.js';
...
if (firebaseConfig.apiKey && firebaseConfig.apiKey !== "YOUR_FIREBASE_API_KEY") {
  try {
    ...
    // Modern local cache initialization supporting multiple tabs
    ...
    enabled = true;
    console.log("Firebase initialized successfully with multi-tab local persistence.");
  } catch (error) {
